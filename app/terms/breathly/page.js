...
export const metadata = {
  title: "Terms of Use - Breathly: Breathing Exercises",
  description:
    "Terms of Use for the Breathly: Breathing Exercises application by EasyTech Agency",
};

export default function BreathlyTerms() {
  return (
    <div className="legal-content">
      <h1>Terms of Use - Breathly: Breathing Exercises</h1>
      <p>
      ...
      <p>
        {`By downloading, installing, or using the Breathly: Breathing Exercises
      ...
      <p>
        {`Breathly is a mobile application that provides guided breathing exercises
        featuring over 15 techniques, visual animations, and haptic feedback to
        help users practice mindful breathing, reduce stress, and improve
        overall well-being.`}
      </p>
      ...
      <p>
        {`Breathly offers both free and premium features. Premium features are
      ...
      <p>
        {`The App and all its content, including but not limited to breathing
        techniques, animations, graphics, logos, icons, and software, are the
      ...
      <h2>7. Disclaimers</h2>
      <p>
        {`The App is provided "as is" without warranty of any kind. Breathly is
        designed for general wellness and relaxation purposes. The App:`}
      </p>
      <ul style={{ marginLeft: "2rem", marginBottom: "1rem" }}>
        <li>
        ...
        <li>
          People with respiratory conditions, cardiovascular issues, or any
          medical concerns should consult a doctor before using the App
        </li>
      </ul>
      ...
      <div style={{ marginTop: "3rem", textAlign: "center" }}>
        <Link href="/apps/breathly" className="btn">
          Back to Breathly
        </Link>
      </div>
    </div>

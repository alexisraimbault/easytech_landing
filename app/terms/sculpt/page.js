...
export const metadata = {
  title: "Terms of Use - Sculpt: Face Yoga & Exercises",
  description:
    "Terms of Use for the Sculpt: Face Yoga & Exercises application by EasyTech Agency",
};

export default function SculptTerms() {
  return (
    <div className="legal-content">
      <h1>Terms of Use - Sculpt: Face Yoga & Exercises</h1>
      <p>
      ...
      <p>
        {`By downloading, installing, or using the Sculpt: Face Yoga & Exercises
      ...
      <p>
        {`Sculpt is a mobile application that provides face yoga and facial
        exercise routines designed to help users tone and strengthen facial
        muscles. The App offers personalized routines, guided exercises, and
        progress tracking to support your facial fitness goals.`}
      </p>
      ...
      <p>
        {`Sculpt offers both free and premium features. Premium features are
      ...
      <p>
        {`The App and all its content, including but not limited to exercise
        routines, illustrations, graphics, logos, icons, and software, are the
      ...
      <h2>7. Disclaimers</h2>
      <p>
        {`The App is provided "as is" without warranty of any kind. Sculpt is
        designed for general wellness and personal care purposes. The App:`}
      </p>
      <ul style={{ marginLeft: "2rem", marginBottom: "1rem" }}>
        <li>
        ...
        <li>Does not guarantee specific results or outcomes</li>
        <li>
          Should not be used as a replacement for treatment prescribed by a
          healthcare professional
        </li>
        <li>
          Users with facial conditions, recent facial surgery, or any medical
          concerns should consult a doctor before using the App
        </li>
      </ul>
      ...
      <div style={{ marginTop: "3rem", textAlign: "center" }}>
        <Link href="/apps/sculpt" className="btn">
          Back to Sculpt
        </Link>
      </div>
    </div>

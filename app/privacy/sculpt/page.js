...
export const metadata = {
  title: "Privacy Policy - Sculpt - Face Yoga & Exercises",
  description:
    "Privacy Policy for the Sculpt - Face Yoga & Exercises application by EasyTech Agency",
};

export default function SculptPrivacy() {
  return (
    <div className="legal-content">
      <h1>Privacy Policy - Sculpt - Face Yoga & Exercises</h1>
      <p>
      ...
      <p>
        {`EasyTech Agency ("we," "our," or "us") operates the Sculpt - Face Yoga & Exercises
      ...
      <ul style={{ marginLeft: "2rem", marginBottom: "1rem" }}>
        <li>Exercise progress and completion history</li>
        <li>Routine preferences and custom routines</li>
        <li>Streak data and daily goals</li>
      </ul>
      <p>
      ...
      <p>
        Certain exercises may use the camera for face tracking to guide you
        through movements. When using camera features:
      </p>
      <ul style={{ marginLeft: "2rem", marginBottom: "1rem" }}>
        <li>
          <strong>
            Face tracking is performed entirely on-device
          </strong>
        </li>
        <li>No photos or videos are captured, stored, or transmitted</li>
        <li>No facial data is sent to any server or third party</li>
        <li>
          You can revoke camera access at any time in your device settings
        </li>
        <li>
          Camera features are entirely optional — all exercises can be completed
          without the camera
        </li>
      </ul>
      ...
      <ul style={{ marginLeft: "2rem", marginBottom: "1rem" }}>
        <li>Which exercises and routines are most popular</li>
      ...
      <p>
        {`We take data security seriously. Your exercise and progress data is
        stored locally on your device and is protected by your device's built-in
        security features. Camera data never leaves your device. Subscription
        data is secured by Apple and RevenueCat.`}
      </p>
      ...
      <div style={{ marginTop: "3rem", textAlign: "center" }}>
        <Link href="/apps/sculpt" className="btn">
          Back to Sculpt - Face Yoga & Exercises
        </Link>
      </div>
    </div>
  );

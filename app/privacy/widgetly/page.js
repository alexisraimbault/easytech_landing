...
export const metadata = {
  title: "Privacy Policy - Widgetly - Widget & Icon Themes",
  description:
    "Privacy Policy for the Widgetly - Widget & Icon Themes application by EasyTech Agency",
};

export default function WidgetlyPrivacy() {
  return (
    <div className="legal-content">
      <h1>Privacy Policy - Widgetly - Widget & Icon Themes</h1>
      <p>
      ...
      <p>
        {`EasyTech Agency ("we," "our," or "us") operates the Widgetly - Widget & Icon Themes
      ...
      <ul style={{ marginLeft: "2rem", marginBottom: "1rem" }}>
        <li>Widget configurations and layouts</li>
        <li>Theme preferences and icon customizations</li>
      ...
      <p>
        The App may access your photo library for photo widgets. When using
        photo features:
      </p>
      <ul style={{ marginLeft: "2rem", marginBottom: "1rem" }}>
        <li>
      ...
      <p>
        The App uses widgets to display content on your home screen. Widget data
        is shared between the App and its widgets via App Groups, an on-device
        mechanism provided by Apple. This data stays entirely on your device and
      ...
      <ul style={{ marginLeft: "2rem", marginBottom: "1rem" }}>
        <li>Which widget types and themes are most popular</li>
      ...
      <p>
        {`We take data security seriously. Your widget configurations and theme
        preferences are stored locally on your device and are protected by your
        device's built-in security features. Photos are never transmitted
        outside your device. Subscription data is secured by Apple and
        RevenueCat.`}
      </p>
      ...
      <div style={{ marginTop: "3rem", textAlign: "center" }}>
        <Link href="/apps/widgetly" className="btn">
          Back to Widgetly - Widget & Icon Themes
        </Link>
      </div>
    </div>
  );

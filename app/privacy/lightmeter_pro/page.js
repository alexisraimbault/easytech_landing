  ...
  return (
    <div className="legal-content">
      ...
      <p>
        ...
        parties. Your data remains on your device except when you explicitly
        use the AI Scene Analysis feature (see Section 6 below), in which case
        only the photo and sensor data are sent to Anthropic for processing.`}
      </p>
      ...
      <h3>AI Scene Analysis — Anthropic (Claude)</h3>
      <p>

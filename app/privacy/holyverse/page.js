...
export const metadata = {
  title: "Privacy Policy - HolyVerse - Bible Verse Widget",
  description:
    "Privacy Policy for the HolyVerse - Bible Verse Widget application by EasyTech Agency",
};

export default function HolyVersePrivacy() {
  return (
    <div className="legal-content">
      <h1>Privacy Policy - HolyVerse - Bible Verse Widget</h1>
      <p>
      ...
      <p>
        {`EasyTech Agency ("we," "our," or "us") operates the HolyVerse - Bible Verse Widget
      ...
      <p>
        The App includes widgets that display Bible verses on your home screen.
        Widget data is shared between the App and its widgets via App Groups, an
        on-device mechanism provided by Apple. This data stays entirely on your
        device and is never transmitted externally.
      </p>
      ...
      <ul style={{ marginLeft: "2rem", marginBottom: "1rem" }}>
        <li>Which features and verse categories are most popular</li>
      ...
      <p>
        {`We take data security seriously. Your favorites, reading history, and
        preferences are stored locally on your device and are protected by your
        device's built-in security features. Subscription data is secured by
      ...
      <div style={{ marginTop: "3rem", textAlign: "center" }}>
        <Link href="/apps/holyverse" className="btn">
          Back to HolyVerse - Bible Verse Widget
        </Link>
      </div>
    </div>
  );
